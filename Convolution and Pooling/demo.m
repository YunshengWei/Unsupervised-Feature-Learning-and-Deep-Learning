...
load ../STL-10/stlTrainSubset.mat % loads numTrainImages, trainImages, trainLabels
...
for i = 1:1000    
    ...
    features = feedForwardAutoencoder(sparseAEModel, hiddenSize, visibleSize, patch); 
...
load ../STL-10/stlTrainSubset.mat % loads numTrainImages, trainImages, trainLabels
load ../STL-10/stlTestSubset.mat  % loads numTestImages,  testImages,  testLabels
...
softmaxModel = softmaxTrain(numel(pooledFeaturesTrain) / numTrainImages,...
    numClasses, softmaxLambda, softmaxX, softmaxY, 'lbfgs', options.maxIter);
